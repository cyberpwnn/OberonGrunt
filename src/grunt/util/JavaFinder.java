...
public class JavaFinder
{
	 ...
	 *          HKEY_LOCAL_MACHINE)
	 * @param wow64
	 *            0 for standard registry access (32-bits for 32-bit app, 64-bits
	 *            for 64-bits app) or WinRegistry.KEY_WOW64_32KEY to force access to
	 *            32-bit registry view, or WinRegistry.KEY_WOW64_64KEY to force
	 *            access to 64-bit registry view
	 * @param previous:
	 *            Insert all entries from this list at the beggining of the results
	 *************************************************************************/
	...
	{
		boolean isOS64 = OSF.is64BitWindows();
